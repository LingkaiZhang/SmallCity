package com.meosun.lib_base.view;
...
public class CountDownTextView extends TextView {
     ...
     * 提示文字
     */
    private String mHintText = "重新发送短信";
     ...
     * 可用状态下字体颜色Id
     */
    private int usableColorId = R.color.common_text;
    /**
     * 不可用状态下字体颜色Id
     */
    private int unusableColorId = R.color.common_text;
...
//                    Log.e("l", mLastMillis + "");
    ...
    public void setUsable(boolean usable) {
        ...
        if (usable) {
            ...
            setText( mLastMillis / 1000+"秒后可重发");
        }
